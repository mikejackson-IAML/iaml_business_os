...
Plans:
- [x] 04-01-PLAN.md — Schema extension and query/mutation functions
- [x] 04-02-PLAN.md — Base LogisticsCard and People/Accommodations cards
- [x] 04-03-PLAN.md — Venue, BEO, Materials, AV, and virtual-specific cards
- [x] 04-04-PLAN.md — Expenses section and tab integration
