...
phase: 04
plan: 04-03
title: Filter Toolbar Component
wave: 1
depends_on: []
files_modified:
...
# Plan 04-03: Filter Toolbar Component

## Objective

Create the filter toolbar with dropdown filters, search input, active filter chips, and clear all button.
...
- `dashboard/src/app/dashboard/digital/workflows/workflows-content.tsx` - Filter pattern
- `dashboard/src/lib/api/task-types.ts` - Valid filter values

## Tasks

<task id="1">
Create task-filters.tsx component

File: `dashboard/src/app/dashboard/action-center/components/task-filters.tsx`
...
# Check file exists
ls dashboard/src/app/dashboard/action-center/components/task-filters.tsx
```

## Must-Haves

- [ ] TaskFilterToolbar component exports correctly
- [ ] All 6 filter types implemented (status, priority, due, department, type, source)
- [ ] Search input with debounce
- [ ] Multi-select dropdowns work
- [ ] Active filter chips appear with remove functionality
- [ ] Clear All button resets everything
- [ ] emptyFilters constant exported
