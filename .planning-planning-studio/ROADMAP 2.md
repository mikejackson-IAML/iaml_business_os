...
Plans:
- [x] 08-01-PLAN.md — Research backend: Perplexity API route, markers, system prompts (Wave 1)
- [x] 08-02-PLAN.md — Chat integration: SSE events, suggestion cards (Wave 2)
- [x] 08-03-PLAN.md — Research panel UI: list, modal, manual trigger (Wave 2)
- [x] 08-04-PLAN.md — Results integration: context injection, sidebar refresh (Wave 3)
