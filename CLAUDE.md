...
When `BUILD-PLAN.md` exists in the project root, GSD commands automatically operate
in autonomous mode — extracting decisions instead of asking questions.

- **GSD commands detect BUILD-PLAN.md natively** and adjust their flow
- **NEVER ask clarifying questions** if the answer exists in BUILD-PLAN.md
- **If BUILD-PLAN.md doesn't cover something:** Make the best default decision, document it, continue
- **Section 14** lists the ONLY things that may require human input — everything else is pre-decided
