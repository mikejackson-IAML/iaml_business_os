// Serverless function to handle CONTACTS table operations
// Supports: GET (search by email), POST (create new contact)
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const TABLE_NAME = 'tblrnWUWDTYe2XOUt'; // CONTACTS table
    ...
    if (req.method === 'POST') {
      ...
      if (!fields || !fields['First Name'] || !fields['Last Name'] || !fields['Email']) {
