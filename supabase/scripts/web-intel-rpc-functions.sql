...
BEGIN
  ...
  IF NOT FOUND THEN
    -- If no record exists, create one with just source_breakdown
...
-- For TRF-05 Anomaly Detector workflow
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_traffic_anomalies_unacked ON web_intel.traffic_anomalies(acknowledged) WHERE acknowledged = FALSE;
...
-- ============================================
-- ALERTS TABLE
-- For storing traffic anomalies and other alerts
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_alerts_created ON web_intel.alerts(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_alerts_unacked ON web_intel.alerts(acknowledged) WHERE acknowledged = FALSE;
...
-- Provides rolling averages for anomaly detection
-- ============================================
...
-- ============================================
-- Check that these functions from TRF-01 exist:
-- public.insert_daily_traffic()
-- public.insert_collection_log()
